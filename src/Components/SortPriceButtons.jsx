...
function SortPriceButtons ({data, setData}) {
    ...
    <div className="ml-2 d-flex flex-column">
        <Link to={"desc"}><Button onClick={handleClickArrowUp} variant="secondary" className="p-0 pl-1 pr-1 rounded-0"
            css={css`
        ...
        <Link to={"asc"}><Button onClick={handleClickArrowDown}  variant="secondary" className="p-0 pl-1 pr-1 rounded-0"
            css={css`
                background-color: white;
                border: 1px black solid;
                color: black;
